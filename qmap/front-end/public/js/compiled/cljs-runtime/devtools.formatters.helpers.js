...
var G__28886 = devtools.prefs.pref(v);
v = G__28886;
continue;
} else {
return v;
...
}catch (e28808){var _e__26694__auto__ = e28808;
return false;
}})();
...
}catch (e28817){var _e__26694__auto__ = e28817;
return false;
}})();
...
}catch (e28820){var _e__26694__auto__ = e28820;
return false;
}}
}
});
...
var vec__28840 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28840,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28840,(1),null);
...
return cljs.core.some((function (p1__28845_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28845_SHARP_);
}),template);
});
