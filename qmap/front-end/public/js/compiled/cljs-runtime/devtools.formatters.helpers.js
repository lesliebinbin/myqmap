...
var G__28863 = devtools.prefs.pref(v);
v = G__28863;
continue;
} else {
return v;
...
}catch (e28801){var _e__26697__auto__ = e28801;
return false;
}})();
...
}catch (e28806){var _e__26697__auto__ = e28806;
return false;
}})();
...
}catch (e28811){var _e__26697__auto__ = e28811;
return false;
}}
}
});
...
var vec__28826 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28826,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28826,(1),null);
...
return cljs.core.some((function (p1__28829_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28829_SHARP_);
}),template);
});
