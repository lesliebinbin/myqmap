...
var o__26626__auto___29821 = (function (){var o__26626__auto__ = (function (){var o__26626__auto__ = Promise;
return (o__26626__auto__["resolve"]).call(o__26626__auto__);
})();
return (o__26626__auto__["then"]).call(o__26626__auto__,callback);
})();
(o__26626__auto___29821["catch"]).call(o__26626__auto___29821,devtools.async.rethrow_outside_promise);
...
var G__29820_29822 = Error;
var target__26631__auto___29823 = G__29820_29822;
if(cljs.core.truth_(target__26631__auto___29823)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29820_29822)].join(''),"\n","target__26631__auto__"].join('')));
}

(target__26631__auto___29823["stackTraceLimit"] = Infinity);
