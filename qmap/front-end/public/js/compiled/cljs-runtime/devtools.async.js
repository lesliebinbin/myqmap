...
var o__26671__auto___30005 = (function (){var o__26671__auto__ = (function (){var o__26671__auto__ = Promise;
return (o__26671__auto__["resolve"]).call(o__26671__auto__);
})();
return (o__26671__auto__["then"]).call(o__26671__auto__,callback);
})();
(o__26671__auto___30005["catch"]).call(o__26671__auto___30005,devtools.async.rethrow_outside_promise);
...
var G__30004_30006 = Error;
var target__26694__auto___30007 = G__30004_30006;
if(cljs.core.truth_(target__26694__auto___30007)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30004_30006)].join(''),"\n","target__26694__auto__"].join('')));
}

(target__26694__auto___30007["stackTraceLimit"] = Infinity);
