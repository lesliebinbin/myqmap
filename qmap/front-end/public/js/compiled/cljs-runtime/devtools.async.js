...
var o__26666__auto___29991 = (function (){var o__26666__auto__ = (function (){var o__26666__auto__ = Promise;
return (o__26666__auto__["resolve"]).call(o__26666__auto__);
})();
return (o__26666__auto__["then"]).call(o__26666__auto__,callback);
})();
(o__26666__auto___29991["catch"]).call(o__26666__auto___29991,devtools.async.rethrow_outside_promise);
...
var G__29990_29994 = Error;
var target__26677__auto___29995 = G__29990_29994;
if(cljs.core.truth_(target__26677__auto___29995)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29990_29994)].join(''),"\n","target__26677__auto__"].join('')));
}

(target__26677__auto___29995["stackTraceLimit"] = Infinity);
