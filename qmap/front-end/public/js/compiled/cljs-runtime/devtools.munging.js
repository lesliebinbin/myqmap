...
var o28482 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28482["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28483 = temp__5718__auto____$1;
return (o28483["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26626__auto__ = f;
return (o__26626__auto__["toString"]).call(o__26626__auto__);
} else {
return "";
}
}catch (e28484){var _ = e28484;
return "";
}});
...
try{var o__26626__auto___28713 = t;
(o__26626__auto___28713["cljs$lang$ctorPrWriter"]).call(o__26626__auto___28713,t,writer);
}catch (e28486){var __28714 = e28486;
}
...
var char_code = (function (){var o__26626__auto__ = (new String(char$));
return (o__26626__auto__["charCodeAt"]).call(o__26626__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26626__auto__ = String;
return (o__26626__auto__["fromCharCode"]).call(o__26626__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28496 = num_code;
switch (G__28496) {
case (1):
return (185);
...
var o__26626__auto__ = String;
return (o__26626__auto__["fromCharCode"]).call(o__26626__auto__,superscript_code);
});
/**
...
}catch (e28502){var _e__26633__auto__ = e28502;
return false;
}})())){
...
var vec__28504 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28504,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o28507 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28507["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28508 = temp__5718__auto____$1;
return (o28508["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28511){
var vec__28512 = p__28511;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28512,(0),null);
...
var G__28726 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28727 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28726;
remaining_tokens = G__28727;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28509){
var G__28510 = cljs.core.first(seq28509);
var seq28509__$1 = cljs.core.next(seq28509);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28510,seq28509__$1);
});
...
var vec__28523 = cljs.core.split_with((function (p1__28521_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28521_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28523,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28523,(1),null);
...
var vec__28531 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28531,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28531,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28735 = cljs.core.rest(remaining_tokens);
var G__28736 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28735;
name_tokens = G__28736;
continue;
} else {
...
var vec__28541 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28541,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28541,(1),null);
var vec__28544 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28544,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28544,(1),null);
var vec__28547 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28547,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28547,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28547,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28547,(3),null);
...
var vec__28565 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28565,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28565,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28565,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28565,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28565,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28565,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__28573 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28573,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28573,(1),null);
var vec__28576 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28576,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28576,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28591 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28591) : devtools.munging.parse_fn_info_deep.call(null,G__28591));
})()));
}
} else {
return fn_info;
...
var G__28758 = (arity + (1));
var G__28759 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28609_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28610_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___28765 = arguments.length;
var i__4731__auto___28766 = (0);
while(true){
if((i__4731__auto___28766 < len__4730__auto___28765)){
args__4736__auto__.push((arguments[i__4731__auto___28766]));

var G__28767 = (i__4731__auto___28766 + (1));
i__4731__auto___28766 = G__28767;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28626){
var vec__28628 = p__28626;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28628,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28616){
var G__28617 = cljs.core.first(seq28616);
var seq28616__$1 = cljs.core.next(seq28616);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28617,seq28616__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28667__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28667__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28667__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28667__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28668 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28668,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28668,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28668,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28668,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28668,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28668,(5),null);
...
var o__26626__auto__ = f;
return (o__26626__auto__["getBasis"]).call(o__26626__auto__);
});
/**
...
}catch (e28677){var _e__26633__auto__ = e28677;
...
var G__28771 = (obj[cljs.core.first(path)]);
var G__28772 = cljs.core.rest(path);
obj = G__28771;
path = G__28772;
continue;
} else {
...
return (function (accum,p__28685){
var vec__28686 = p__28685;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28686,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28686,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28691){
var vec__28692 = p__28691;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28692,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28692,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28692,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28701,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28701,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__28701,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28699_SHARP_){
return (obj[cljs.core.first(p1__28699_SHARP_)]);
});})(name,sorted_matches,vec__28701,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
